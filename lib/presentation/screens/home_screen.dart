...
class _HomeScreenState extends State<HomeScreen> {
  ...
  ConversationEntity? _activeChat;
  UserEntity? _activeFriend;
  ...
  Widget build(BuildContext context) {
    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        Widget chatList = Directionality(
        ...
        if (!isDesktop) {
          return Scaffold(backgroundColor: scaffoldBg, body: chatList);
        }
        ...
        if (_activeChat == null) {
        ...
        } else if (_activeChat!.isGroup) {
          rightPanel = GroupChatScreen(
          ...
          if (_activeFriend != null) {
            rightPanel = ChatScreen(
              _activeFriend!,
              key: ValueKey(_activeFriend!.id),
            );
          } else {
            rightPanel = const Scaffold();
          }
        }
